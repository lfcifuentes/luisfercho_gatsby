      ...
      <div className="container mx-auto p-12 max-w-4xl flex justify-center items-center">
        <div className="flex-1">
          ...
          <span className="flex mt-2">
            <a className="mr-2" href="https://dev.to/luisfercho" target="_blank" rel="noopener noreferrer">
          ...
          <span className="flex pt-3 items-center">
            <img src={envelop} alt={name+" LinkedIn Profile"} height="30" width="30" />
            <span className="pl-2">
              E-mail: lfcifuentes28@gmail.com
            </span>
          </span>
        </div>
